    ...
    <div class="container xl:max-w-6xl mx-auto px-4">
      <div class="flex flex-wrap flex-row -mx-4 justify-center">
        ...
        <div class="flex-shrink max-w-full px-4 sm:px-12 lg:px-18 w-full sm:w-9/12 lg:w-1/2 self-center">
          <img src="/src/assets/hero.svg" class="w-full max-w-full h-auto" alt="creative agency">
        </div><!-- end content -->
        ...
        <div class="flex-shrink max-w-full px-4 w-full md:w-9/12 lg:w-1/2 self-center lg:pr-12">
          <div class="text-center lg:text-left mt-6 lg:mt-0">
            <div class="mb-12">
              <h1 class="text-4xl leading-normal text-black font-bold mb-4">Control Your Energy, Control Your Future</h1>
            ...
            <a class="py-2.5 px-10 inline-block text-center leading-normal text-gray-900 bg-white border-b border-gray-100 hover:text-black hover:ring-0 focus:outline-none focus:ring-0 mr-4" href="#services" v-smooth-scroll>
              <span class="button-icon"><font-awesome-icon :icon="['far', 'lightbulb']"></font-awesome-icon></span>
              <span class="ml-3">Our Solutions</span>
            </a>

            <a class="py-2.5 px-10 inline-block text-center leading-normal text-gray-100 bg-black border-b border-gray-800 hover:text-white hover:ring-0 focus:outline-none focus:ring-0" href="#connect" v-smooth-scroll>
